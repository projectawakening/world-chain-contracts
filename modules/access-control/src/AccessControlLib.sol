...
library AccessControlLib {
  ...
  function supportsInterface(World memory world, bytes4 interfaceId) internal returns(bool) {
    bytes memory returnData = world.iface.call(world.namespace.accessControlSystemId(),
  ...
  function claimSingletonRole(World memory world, address callerConfirmation) internal {
    world.iface.call(world.namespace.accessControlSystemId(),
  ...
  function setOnlyRoleANDConfig(World memory world, uint256 entityId, bytes32[] memory roles) internal {
    world.iface.call(world.namespace.accessControlSystemId(),
  ...
  function setOnlyRoleORConfig(World memory world, uint256 entityId, bytes32[] memory roles) internal {
    world.iface.call(world.namespace.accessControlSystemId(),

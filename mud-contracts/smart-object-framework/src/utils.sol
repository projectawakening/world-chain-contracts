...
import { ENTITY_CORE_SYSTEM_NAME, MODULE_CORE_SYSTEM_NAME, HOOK_CORE_SYSTEM_NAME } from "@eve/common-constants/src/constants.sol";
...
library Utils {
  ...
  function entityTypeTableId(bytes14 namespace) internal pure returns (ResourceId) {
    return
      WorldResourceIdLib.encode({ typeId: RESOURCE_TABLE, namespace: namespace, name: ENTITY_TYPE_NAME });
  }

  function entityTableTableId(bytes14 namespace) internal pure returns (ResourceId) {
    return
      WorldResourceIdLib.encode({ typeId: RESOURCE_TABLE, namespace: namespace, name: ENTITY_TABLE_NAME });
  }
  ...
  function entityMapTableId(bytes14 namespace) internal pure returns (ResourceId) {
    return
      WorldResourceIdLib.encode({ typeId: RESOURCE_TABLE, namespace: namespace, name: ENTITY_MAP_NAME });
  }
  ...
  function moduleTableTableId(bytes14 namespace) internal pure returns (ResourceId) {
    return
      WorldResourceIdLib.encode({ typeId: RESOURCE_TABLE, namespace: namespace, name: MODULE_TABLE_NAME });
  }
  ...
  function hookTableTableId(bytes14 namespace) internal pure returns (ResourceId) {
    return
      WorldResourceIdLib.encode({ typeId: RESOURCE_TABLE, namespace: namespace, name: HOOK_TABLE_NAME });
  }

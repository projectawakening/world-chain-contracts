...
library InventoryItemTable {
   ...
   */
  function set(uint256 smartObjectId, uint256 inventoryItemId, InventoryItemTableData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(uint256 smartObjectId, uint256 inventoryItemId, InventoryItemTableData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.quantity, _table.index, _table.stateUpdate);

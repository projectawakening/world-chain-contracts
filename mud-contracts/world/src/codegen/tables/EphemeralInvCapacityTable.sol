...
library EphemeralInvCapacityTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "eveworld", name: "EphemeralInvCapa", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462657665776f726c64000000000000457068656d6572616c496e7643617061);
   ...
   * @notice Get capacity.
   */
  function get(uint256 smartObjectId) internal view returns (uint256 capacity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Get capacity.
   */
  function _get(uint256 smartObjectId) internal view returns (uint256 capacity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set capacity.
   */
  function set(uint256 smartObjectId, uint256 capacity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set capacity.
   */
  function _set(uint256 smartObjectId, uint256 capacity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));

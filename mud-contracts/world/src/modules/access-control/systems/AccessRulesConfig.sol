...
contract AccessRulesConfig is EveSystem {
   ...
   * @param enforcement - the level of enforcement to apply these roleIds to TRANSIENT or ORIGIN are valid here
   * @param roleIds- the roleId array data for each context of this configuration
   */

...
import { FuelData } from "./../index.sol";
...
interface IFuelSystem {
  ...
  function eveworld__getFuelBalance(uint256 entityId) external view returns (FuelData memory);
  ...
  function eveworld__getFuelAmount(uint256 entityId) external view returns (uint256 fuelAmount);

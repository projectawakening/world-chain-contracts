...
library ItemTransferOffchainTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "eveworld", name: "ItemTransferOffc", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462657665776f726c640000000000004974656d5472616e736665724f666663);
   ...
   */
  function set(uint256 smartObjectId, uint256 inventoryItemId, ItemTransferOffchainTableData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(uint256 smartObjectId, uint256 inventoryItemId, ItemTransferOffchainTableData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.previousOwner,
      _table.currentOwner,
      _table.quantity,

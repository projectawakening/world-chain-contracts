...
library InventoryItemTable {
   ...
   * @notice Get quantity.
   */
  function getQuantity(uint256 smartObjectId, uint256 itemId) internal view returns (uint256 quantity) {
   ...
   * @notice Get quantity.
   */
  function _getQuantity(uint256 smartObjectId, uint256 itemId) internal view returns (uint256 quantity) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Set quantity.
   */
  function setQuantity(uint256 smartObjectId, uint256 itemId, uint256 quantity) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Set quantity.
   */
  function _setQuantity(uint256 smartObjectId, uint256 itemId, uint256 quantity) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Get index.
   */
  function getIndex(uint256 smartObjectId, uint256 itemId) internal view returns (uint256 index) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Get index.
   */
  function _getIndex(uint256 smartObjectId, uint256 itemId) internal view returns (uint256 index) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Set index.
   */
  function setIndex(uint256 smartObjectId, uint256 itemId, uint256 index) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Set index.
   */
  function _setIndex(uint256 smartObjectId, uint256 itemId, uint256 index) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   */
  function getStateUpdate(uint256 smartObjectId, uint256 itemId) internal view returns (uint256 stateUpdate) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Get stateUpdate.
   */
  function _getStateUpdate(uint256 smartObjectId, uint256 itemId) internal view returns (uint256 stateUpdate) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   */
  function setStateUpdate(uint256 smartObjectId, uint256 itemId, uint256 stateUpdate) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   * @notice Set stateUpdate.
   */
  function _setStateUpdate(uint256 smartObjectId, uint256 itemId, uint256 stateUpdate) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(itemId));
   ...
   */
  function set(uint256 smartObjectId, uint256 itemId, uint256 quantity, uint256 index, uint256 stateUpdate) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(uint256 smartObjectId, uint256 itemId, uint256 quantity, uint256 index, uint256 stateUpdate) internal {
    bytes memory _staticData = encodeStatic(quantity, index, stateUpdate);

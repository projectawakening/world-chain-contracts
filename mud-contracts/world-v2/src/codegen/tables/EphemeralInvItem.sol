...
library EphemeralInvItem {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "eveworld", name: "EphemeralInvItem", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462657665776f726c64000000000000457068656d6572616c496e764974656d);
   ...
   */
  function deleteRecord(uint256 smartObjectId, uint256 inventoryItemId, address ephemeralInvItemOwner) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(inventoryItemId));
    _keyTuple[2] = bytes32(uint256(uint160(ephemeralInvItemOwner)));
   ...
   * @notice Delete all data for given keys.
   */
  function _deleteRecord(uint256 smartObjectId, uint256 inventoryItemId, address ephemeralInvItemOwner) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
    _keyTuple[1] = bytes32(uint256(inventoryItemId));
    _keyTuple[2] = bytes32(uint256(uint160(ephemeralInvItemOwner)));

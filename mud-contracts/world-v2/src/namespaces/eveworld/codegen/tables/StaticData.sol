...
library StaticData {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "eveworld", name: "StaticData", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462657665776f726c6400000000000053746174696344617461000000000000);

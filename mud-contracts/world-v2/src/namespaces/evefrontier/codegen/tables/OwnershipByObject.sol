...
library OwnershipByObject {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "evefrontier", name: "OwnershipByObjec", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746265766566726f6e746965720000004f776e65727368697042794f626a6563);
   ...
   * @notice Get account.
   */
  function getAccount(uint256 smartObjectId) internal view returns (address account) {
   ...
   * @notice Get account.
   */
  function _getAccount(uint256 smartObjectId) internal view returns (address account) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Get account.
   */
  function get(uint256 smartObjectId) internal view returns (address account) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Get account.
   */
  function _get(uint256 smartObjectId) internal view returns (address account) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set account.
   */
  function setAccount(uint256 smartObjectId, address account) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set account.
   */
  function _setAccount(uint256 smartObjectId, address account) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set account.
   */
  function set(uint256 smartObjectId, address account) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set account.
   */
  function _set(uint256 smartObjectId, address account) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));

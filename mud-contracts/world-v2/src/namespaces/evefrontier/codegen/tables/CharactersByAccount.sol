...
library CharactersByAccount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "evefrontier", name: "CharactersByAcco", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746265766566726f6e746965720000004368617261637465727342794163636f);
   ...
   */
  function getSmartObjectId(address account) internal view returns (uint256 smartObjectId) {
   ...
   * @notice Get smartObjectId.
   */
  function _getSmartObjectId(address account) internal view returns (uint256 smartObjectId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Get smartObjectId.
   */
  function get(address account) internal view returns (uint256 smartObjectId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Get smartObjectId.
   */
  function _get(address account) internal view returns (uint256 smartObjectId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   */
  function setSmartObjectId(address account, uint256 smartObjectId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Set smartObjectId.
   */
  function _setSmartObjectId(address account, uint256 smartObjectId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Set smartObjectId.
   */
  function set(address account, uint256 smartObjectId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Set smartObjectId.
   */
  function _set(address account, uint256 smartObjectId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));

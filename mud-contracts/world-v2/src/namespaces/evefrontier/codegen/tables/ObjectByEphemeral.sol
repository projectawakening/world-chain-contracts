...
library ObjectByEphemeral {
   ...
   * @notice Get smartObjectId.
   */
  function get(uint256 ephemeralSmartObjectId) internal view returns (uint256 smartObjectId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(ephemeralSmartObjectId));
   ...
   * @notice Get smartObjectId.
   */
  function _get(uint256 ephemeralSmartObjectId) internal view returns (uint256 smartObjectId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(ephemeralSmartObjectId));
   ...
   * @notice Set smartObjectId.
   */
  function set(uint256 ephemeralSmartObjectId, uint256 smartObjectId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(ephemeralSmartObjectId));
   ...
   * @notice Set smartObjectId.
   */
  function _set(uint256 ephemeralSmartObjectId, uint256 smartObjectId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(ephemeralSmartObjectId));

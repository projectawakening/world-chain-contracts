...
library Lens {
  ...
  function getFieldNames() internal pure returns (string[] memory fieldNames) {
    ...
    fieldNames[0] = "durability";
    fieldNames[1] = "exhausted";
  }
  ...
  function setDurability(uint256 lensId, uint256 durability) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((durability)), _fieldLayout);
  }
  ...
  function _setDurability(uint256 lensId, uint256 durability) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((durability)), _fieldLayout);
  }
  ...
  function setExhausted(uint256 lensId, bool exhausted) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((exhausted)), _fieldLayout);
  }
  ...
  function _setExhausted(uint256 lensId, bool exhausted) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((exhausted)), _fieldLayout);
  }
   ...
   */
  function set(uint256 lensId, uint256 durability, bool exhausted) internal {
    bytes memory _staticData = encodeStatic(durability, exhausted);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(uint256 lensId, uint256 durability, bool exhausted) internal {
    bytes memory _staticData = encodeStatic(durability, exhausted);
  ...
  function set(uint256 lensId, LensData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.durability, _table.exhausted);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (uint256 durability, bool exhausted) {
    durability = (uint256(Bytes.getBytes32(_blob, 0)));

    exhausted = (_toBool(uint8(Bytes.getBytes1(_blob, 32))));
  }
  ...
  function decode(
    ...
    (_table.durability, _table.exhausted) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(uint256 durability, bool exhausted) internal pure returns (bytes memory) {
    return abi.encodePacked(durability, exhausted);
  }

...
contract InventoryOwnershipSystem is SmartObjectFramework {
     ...
     */
    function _updateEphemeralInventory(
        uint256 inventoryObjectId,
        uint256 itemObjectId,
        uint256 quantity
    ) internal {
     ...
     * @param quantity The quantity to add
     */
    function _updateRegularInventory(
        uint256 inventoryObjectId,
        uint256 itemObjectId,
        uint256 quantity
    ) internal {
     ...
     * @param quantity The quantity to remove
     */
    function _removeFromEphemeralInventory(
        uint256 inventoryObjectId,
        uint256 itemObjectId,
        uint256 quantity
    ) internal {
        ...
        uint256 existingItemQuantity = currentVersion > recordedVersion ? 0 : 
     ...
     * @param quantity The quantity to remove
     */
    function _removeFromRegularInventory(
        uint256 inventoryObjectId,
        uint256 itemObjectId,
        uint256 quantity
    ) internal {
        ...
        if (existingItemQuantity < quantity) {
            revert InventoryOwnership_InsufficientQuantity(
                inventoryObjectId,
                itemObjectId,
                quantity,
                existingItemQuantity

...
import { GlobalDeployableState, Inventory, Tenant, EntityRecord, EntityRecordData, DeployableState, Characters, CharactersData, DeployableStateData, InventoryItemData, InventoryItem, InventoryByItem, OwnershipByObject, EphemeralInvCapacity, CharactersByAccount, LocationData, InventoryByEphemeral, InventoryByEphemeralData, SmartAssembly, Fuel, FuelData, Location, SmartTurretConfig } from "../../src/namespaces/evefrontier/codegen/index.sol";

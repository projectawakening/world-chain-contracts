...
import { DECIMALS } from "../../src/systems/constants.sol";
...
contract FuelTest is MudTest {
  ...
  function testFuelConsumption(
    ...
    ResourceId deployableSystemId = DeployableUtils.smartDeployableSystemId();
    world.call(deployableSystemId, abi.encodeCall(DeployableSystem.bringOnline, (entityId)));
  ...
  function testFuelRefundDuringGlobalOffline(
    ...
    world.call(deployableSystemId, abi.encodeCall(DeployableSystem.anchor, (entityId, location)));
    // bring online
    world.call(deployableSystemId, abi.encodeCall(DeployableSystem.bringOnline, (entityId)));
  ...
  function testRegisterDeployable(
    ...
    ResourceId systemId = DeployableUtils.smartDeployableSystemId();
    world.call(systemId, abi.encodeCall(DeployableSystem.globalResume, ()));

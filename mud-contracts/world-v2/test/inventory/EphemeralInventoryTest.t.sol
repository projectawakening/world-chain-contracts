...
contract EphemeralInventoryTest is MudTest {
  ...
  //   charEntityRecordData = EntityRecordParams({ tenantId: TENANT_ID, typeId: characterTypeId, itemId: characterItemId, volume: 0 });
  //   ephCharEntityRecordData = EntityRecordParams({ tenantId: TENANT_ID, typeId: characterTypeId, itemId: diffCharacterItemId, volume: 0 });
  ...
  //   items[0] = InventoryItemParams({ inventoryItemId: 4235, owner: owner, itemId: 4235, volume: 100, quantity: 3 });
  //   items[1] = InventoryItemParams({ inventoryItemId: 4236, owner: owner, itemId: 4236, volume: 200, quantity: 2 });
  //   items[2] = InventoryItemParams({ inventoryItemId: 4237, owner: owner, itemId: 4237, volume: 150, quantity: 2 });

  //   testSetEphemeralInventoryCapacity(storageCapacity);

  //   InventoryData memory inventoryData = Inventory.get(smartObjectId, owner);
  ...
  //   //Note: Issue applying fuzz testing for the below array of inputs : https://github.com/foundry-rs/foundry/issues/5343
  //   InventoryItemParams[] memory items = new InventoryItemParams[](3);
  //   items[0] = InventoryItemParams({ inventoryItemId: 4235, owner: owner, itemId: 4235, volume: 100, quantity: 1 });
  //   items[1] = InventoryItemParams({ inventoryItemId: 4236, owner: owner, itemId: 4236, volume: 200, quantity: 2 });
  //   items[2] = InventoryItemParams({ inventoryItemId: 4237, owner: owner, itemId: 4237, volume: 150, quantity: 1 });

...
import { FRONTIER_WORLD_DEPLOYMENT_NAMESPACE as WORLD_NAMESPACE } from "@eve/common-constants/src/constants.sol";
...
import { HookType } from "@eve/frontier-smart-object-framework/src/types.sol";
...
contract AccessRuleMockTest is Test {
  ...
  function testAccessRuleEnforcementLevel3PassingCases() public {
   ...
   // Case2: verify TRANSIENT_AND_ORIGIN, TRANSIENT ONLY roles satisfied
    ...
    console.log(Systems.getSystem(FORWARD_MOCK_SYSTEM_ID));

...
import { STATIC_DATA_DEPLOYMENT_NAMESPACE as STATIC_DATA_NAMESPACE, SMART_OBJECT_DEPLOYMENT_NAMESPACE } from "@eve/common-constants/src/constants.sol";
...
import { IERC721Events } from "../../src/modules/eve-erc721-puppet/IERC721Events.sol";
...
contract ERC721Test is Test, GasReporter, IERC721Events, IERC721Errors {
  ...
  function testSetUp() public {
    ...
    assertEq(NamespaceOwner.get(WorldResourceIdLib.encodeNamespace(DEPLOYMENT_NAMESPACE)), address(this));
  }

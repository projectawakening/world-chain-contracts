...
library EphemeralInvCapacityTable {
   ...
   * @notice Get capacity.
   */
  function get(ResourceId _tableId, uint256 smartObjectId) internal view returns (uint256 capacity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Get capacity.
   */
  function _get(ResourceId _tableId, uint256 smartObjectId) internal view returns (uint256 capacity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set capacity.
   */
  function set(ResourceId _tableId, uint256 smartObjectId, uint256 capacity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   * @notice Set capacity.
   */
  function _set(ResourceId _tableId, uint256 smartObjectId, uint256 capacity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(smartObjectId));
   ...
   */
  function encode(uint256 capacity) internal pure returns (bytes memory, PackedCounter, bytes memory) {

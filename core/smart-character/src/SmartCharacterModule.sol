...
contract SmartCharacterModule is Module {
  ...
  function install(bytes memory encodedArgs) public {
    ...
    (bool success, bytes memory returnedData) = registrationLibrary.delegatecall(abi.encodeCall(SmartCharacterModuleRegistrationLibrary.register, (world, namespace)));
